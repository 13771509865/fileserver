...
import com.yozo.common.constants.EnumResultCode;
import com.yozo.common.utils.JsonResultUtils;
...
public class GlobalDefaultExceptionHandler {
    ...
    public ResponseEntity argValidExceptionHandler(BindException e) {
        ...
        return ResponseEntity.ok(JsonResultUtils.buildMapResult(EnumResultCode.E_INVALID_PARAM.getValue(), message, StringUtils.join(message, ",")));
    }
